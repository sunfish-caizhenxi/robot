...
/*
 * 时间转换：新历转老历,通过getDate()返回 yyyy-MM-dd
 * @author caizx
 *
 */
public class LunarDateUtil {
	...
	/*
	 * public static String getChinaDayString(int day) { String chineseTen[] = {
	 * "初", "十", "廿", "卅" }; int n = day % 10 == 0 ? 9 : day % 10 - 1; if (day >
	 * 30) return ""; if (day == 10) return "初十"; else return chineseTen[day /
	 * 10] + chineseNumber[n]; }
	 * 
	 * public String toString() { return year + "年" + (leap ? "闰" : "") +
	 * chineseNumber[month - 1] + "月" + getChinaDayString(day); }
	 */

	public String toString() {
		return year + "-" + chineseNumber[month - 1] + "-" + day;
	}
