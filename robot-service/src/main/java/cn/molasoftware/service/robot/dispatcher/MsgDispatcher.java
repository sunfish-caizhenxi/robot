...
import cn.molasoftware.dao.robot.util.TuLingRobot;
...
//			}
			TuLingRobot tuLing = new TuLingRobot();
			String answer = tuLing.getByTulingApi2(content);
			if(StringUtils.isNotEmpty(answer)){
				txtmsg.setContent(answer);
			}
